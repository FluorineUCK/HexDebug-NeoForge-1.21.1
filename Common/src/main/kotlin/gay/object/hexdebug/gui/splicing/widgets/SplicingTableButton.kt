...
abstract class SplicingTableButton(
    ...
    override fun isMouseOver(mouseX: Double, mouseY: Double) = isActive && testVisible() && testHitbox(mouseX, mouseY)

    override fun clicked(mouseX: Double, mouseY: Double) = isActive && testVisible() && testHitbox(mouseX, mouseY)
    ...
    override fun renderWidget(guiGraphics: GuiGraphics, mouseX: Int, mouseY: Int, partialTick: Float) {
        ...
        updateFocusForKeyboardNavigation()
    }
    ...
    private fun updateFocusForKeyboardNavigation() {
